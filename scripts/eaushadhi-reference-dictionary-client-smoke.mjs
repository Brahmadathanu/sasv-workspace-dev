...
const desktopModalCss = css.match(/body\.sasv-eaushadhi-review \.reference-dictionary-modal \.modal-card \{[\s\S]*?\n\}/)?.[0] || "";
assert.match(desktopModalCss, /width: min\(1200px, calc\(100vw - 40px\)\)/);
assert.match(desktopModalCss, /height: min\(760px, calc\(100vh - 40px\)\)/);
assert.match(desktopModalCss, /max-height: min\(760px, calc\(100vh - 40px\)\)/);
