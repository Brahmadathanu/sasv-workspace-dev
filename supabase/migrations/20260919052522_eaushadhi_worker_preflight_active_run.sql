-- Additive preflight active-run discovery for Product Details resume/reconcile.
-- No table schema change. No workflow/run data mutation.
-- Ordinary start eligibility remains NOT_STARTED-only.
