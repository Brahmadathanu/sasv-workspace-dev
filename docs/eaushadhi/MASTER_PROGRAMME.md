...
| WP-02 | Global Terminology Governance | BLUE | 70% | Client correction, audit, merge, global verification |
...
**33% — milestone-based tracking baseline, not an effort/time estimate.**
