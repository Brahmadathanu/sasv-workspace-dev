-- RPC (fixed): paginated exceptions with configurable rules
-- Returns a JSON object: { total_count, page, page_size, rows: [...] }
...
DECLARE
  ...
  _rows jsonb;
BEGIN
  -- compute total first (source subquery computes raw_missing flags)
