...
--
-- NOTE: The later force-unlink / GUC-aware guard implementation was archived as
-- historical evidence at:
--   docs/archive/sql/2026-07-16_force_unlink_plan_batch.sql
-- That design has been retired from the live server; do not apply archived SQL
-- as current deployment truth.
